public abstract class Armadura extends Equipo{
    ...
    public abstract boolean accion_especial(boolean proyectil);

    public abstract void accion_especial(boolean melee, int distancia);
}